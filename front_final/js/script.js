...
require(["esri/config",
  ...
  search_destino.on("search-complete", function(event){
      ...
      track.on("track", function(trackEvent){
        ...
        console.log("track: %s", "brrrrr");
        console.log("numero puntos",view.graphics.length);
        console.log("info puntos",view.graphics);
        ...
        if (view.graphics.length === 3){
          ...
          view.graphics.remove(view.graphics._items[1]);
          view.graphics.remove(view.graphics._items[2]);
          getRoute();
...
*/
  ...
  function getRoute() {
    ...
    console.log("Vuelvo a entrar a get route gg"); 
